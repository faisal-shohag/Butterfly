...
import { MessageSquare, Share2, MoreVertical, Trash2, Sparkles, RefreshCw, Archive, Bookmark } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const PostList = ({user}) => {
  ...
  return (<>
   { user && <div className=" ">
    {/* <div className="flex justify-end lg:px-[290px] mb-2 px-5 gap-3"> */}
    {/* <Button
    ...
    <InfiniteScroll
      ...
      hasMore={hasNextPage}
      loader={<Loading/>}
      endMessage={<div className="text-center font-bold text-slate-500 max-w-2xl mx-auto">No more Post</div>}
    >
      {posts.map((post) => (
        <Card
          key={post.id}
          className={`${
            post.type === "ai" ? "" : ""
          } mb-4  max-w-2xl mx-auto dark:bg-[#141414]`}
        >
