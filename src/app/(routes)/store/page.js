...
const Special = () => {
  const books = [
    ...
    },
    {
      ...
      review:
        "My First Quran Storybook is the perfect way to introduce your child to the Quran. Designed for young children, this book shares the timeless stories from the Quran in a simple and engaging format. Each story is beautifully illustrated and includes easy-to-understand language, making it accessible for even the youngest readers. From the story of Adam and Eve to the tale of Prophet Muhammad (peace be upon him), this book covers all the major events and characters in Islamic history. Whether read alone or shared with a parent, My First Quran Storybook is sure to captivate young hearts and minds, providing a solid foundation for future learning and growth.",
      totalPages: 319,
      rating: 4.3,
      category: "Children",
      tags: ["Children", "Story"],
  ...
  return (
    <div className="section">
      ...
      <div className="mt-5 lg:h-[600px] md:h-[500px] h-[400px] w-full relative rounded-xl">
        <Image
          className="rounded-xl"
          src="https://i.postimg.cc/SRBW0Rqy/Blue-Minimalist-Winter-Sale-Banner.jpg"
          alt="Image Alt"
          objectFit="cover"
          layout="fill"
        />
