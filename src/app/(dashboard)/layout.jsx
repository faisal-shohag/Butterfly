    ...
    <div>
      ...
      <div className="flex gap-8 lg:px-6 my-10">
        <div className="w-96 min:h-screen space-y-4 border shadow-md rounded-md p-4 hidden lg:flex flex-col bg-background">
          ...
          <p className="font-medium  w-full rounded-md px-5 py-2 hover:bg-gray-200 ">
            <Link href={"/ordersReport"}>Orders Report</Link>{" "}
          </p>
          <p className="font-medium  w-full rounded-md px-5 py-2 hover:bg-gray-200 ">
            <Link href={"/exchangesPostReport"}>Exchanges Post Report</Link>{" "}
          </p>
          <p className="font-medium  w-full rounded-md px-5 py-2 hover:bg-gray-200 ">
            <Link href={"/hivePostReport"}>Hive Post Report</Link>{" "}
          </p>
          <p className="font-medium  w-full rounded-md px-5 py-2 hover:bg-gray-200 ">
          ...
          <p
            onClick={() => signOut()}
            className="font-medium  w-full rounded-md px-5 py-2 hover:bg-gray-200 flex gap-1 justify-start items-center text-red-500"
          >
