...
const Terms = () => {
    return (
        <div className="px-3 space-y-2">
            ...
            <h2 className="text-xl font-bold opacity-75">2. Account Responsibilities</h2>
            ...
            <h2 className="text-xl font-bold opacity-75">3. Posting Books for Exchange</h2>
            <ul class="list-disc pl-5 space-y-2">
            ...
            <h2 className="text-xl font-bold opacity-75">4. Buying and Selling Books</h2>
            <ul class="list-disc pl-5 space-y-2">
            ...
            <h2 className="text-xl font-bold opacity-75">5. Community Guidelines</h2>
            ...
            <h2 className="text-xl font-bold opacity-75">6. Limitation of Liability</h2>
            <ul class="list-disc pl-5 space-y-2">
